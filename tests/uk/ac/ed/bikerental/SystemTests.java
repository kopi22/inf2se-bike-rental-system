...
public class SystemTests {
    ...
    void setUp() throws Exception {
        ...
        query1 = new Query(new HashMap<String, Integer>(), LocalDate.of(2019, 6, 28), LocalDate.of(2019, 7, 28),
            new Location("EH254GU", "St Leonards"));
        customer1 = new Customer(1, "henryk@gmail.com", "Henryk", "Hobohobo", new Location("EH165AJ", "Akababa"),
            "09875456796", new ArrayList());
        customer2 = new Customer(2, "Alica@gmail.com", "Alica", "Persey", new Location("EH876TZ", "Mayeston"),
    ...
    void makeBookingWithoutConsentTest() {
        ...
        // data for creating booking
        Booking booking = controller.makeBooking(customer1.getCustomerID(), quote1, details1);
        assertNull(booking);
    }
